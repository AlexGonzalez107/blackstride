      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20 items-end">
          <div>
            ...
            <h2 className="text-5xl md:text-7xl font-bold leading-none mb-4 tracking-tighter">
              Built for businesses <br /> at the start of something.
            </h2>
          </div>
          <div className="lg:max-w-md">
            <p className="text-foreground/50 text-lg leading-relaxed mb-6">
              Every site here was a first - a real business, getting online for the first time, done properly.
            </p>
            <a
              href="#contact"
              className="inline-flex items-center gap-2 text-agency-accent text-sm font-bold tracking-widest uppercase hover:underline"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          >
            ...
            <div>
              <span className="text-[10px] font-bold tracking-[0.3em] text-agency-accent uppercase mb-2 block">
                {projects[0].category}
              </span>
