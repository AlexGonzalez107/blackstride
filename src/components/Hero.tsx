    ...
    <section className="relative min-h-screen flex items-center pt-32 pb-20 overflow-hidden">
        ...
        <div className="max-w-4xl">
          ...
          >
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold leading-[1.1] tracking-tight mb-8">
              Getting online shouldn't cost a{' '}
              <span className="relative inline-block">
                fortune
                <span className="absolute bottom-2 left-0 w-full h-1 bg-agency-accent/40 -z-10"></span>
              </span>
              <br />
              <span className="text-agency-accent">or take three months.</span>
            </h1>
          </motion.div>
          ...
          <motion.p
            ...
            className="text-base md:text-lg text-foreground/60 font-medium mb-10 max-w-2xl leading-relaxed"
          >
            Blackstride builds your digital presence the right way - fast, clean, and built to grow with your business.
          </motion.p>
      ...
      <div className="absolute bottom-12 left-0 w-full flex justify-center overflow-hidden px-6">
        ...
        >
          ...
          <span className="text-agency-accent font-display text-xs font-bold tracking-[1.2em] uppercase whitespace-nowrap">
            Built to Move.
          </span>
          <div className="h-[1px] flex-grow bg-agency-border"></div>
        </motion.div>
